export default function MaterialSymbolsPasskeyOutlineRounded(props) {
  return (
    <svg
...
export function IconParkOutlineMoreTwo(props) {
    return (
      <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 48 48" {...props}><g fill="none"><path stroke="currentColor" strokeLinejoin="round" strokeWidth="4" d="M24 44c11.046 0 20-8.954 20-20S35.046 4 24 4S4 12.954 4 24s8.954 20 20 20Z"></path><circle cx="14" cy="24" r="3" fill="currentColor"></circle><circle cx="24" cy="24" r="3" fill="currentColor"></circle><circle cx="34" cy="24" r="3" fill="currentColor"></circle></g></svg>
    )
  }

  
export function CircumSquareMore(props) {
    return (
      <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" {...props}><path fill="currentColor" d="M18.437 20.938H5.562a2.5 2.5 0 0 1-2.5-2.5V5.565a2.5 2.5 0 0 1 2.5-2.5h12.875a2.5 2.5 0 0 1 2.5 2.5v12.873a2.5 2.5 0 0 1-2.5 2.5ZM5.562 4.065a1.5 1.5 0 0 0-1.5 1.5v12.873a1.5 1.5 0 0 0 1.5 1.5h12.875a1.5 1.5 0 0 0 1.5-1.5V5.565a1.5 1.5 0 0 0-1.5-1.5Z"></path><circle cx="11.999" cy="12.002" r="1" fill="currentColor"></circle><circle cx="15.999" cy="12.002" r="1" fill="currentColor"></circle><circle cx="7.999" cy="12.002" r="1" fill="currentColor"></circle></svg>
    )
  }